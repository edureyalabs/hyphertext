    ...
    <main style={{ background: "#F4F2ED", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", color: "#111" }}>
      ...
      <section style={{ borderBottom: "1px solid var(--border)" }}>
        ...
        <div style={{ maxWidth: "960px", margin: "0 auto", padding: "6rem 2.5rem 5rem" }}>
          ...
          <h1 style={{
            ...
            should be for{" "}
            <em style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontWeight: 400, color: "#aaa" }}>
              everyone.
            </em>
          </h1>
          <p style={{ fontSize: "1.1rem", color: "#666", fontWeight: 300, lineHeight: 1.85, maxWidth: "620px" }}>
          ...
          <div className="two-col" style={{ display: "grid", gridTemplateColumns: "220px 1fr", gap: "4rem", alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
              {[
                ...
                <div key={item.title} style={{ paddingLeft: "1rem", borderLeft: `2px solid ${item.color}` }}>
                  <h3 style={{ fontSize: "1.05rem", fontWeight: 500, color: "#111", marginBottom: "0.6rem", letterSpacing: "-0.01em", lineHeight: 1.4 }}>{item.title}</h3>
                  <p style={{ fontSize: "0.92rem", color: "#666", fontWeight: 300, lineHeight: 1.85 }}>{item.body}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div style={{ maxWidth: "960px", margin: "0 auto", padding: "5rem 2.5rem" }}>
          <div className="two-col" style={{ display: "grid", gridTemplateColumns: "220px 1fr", gap: "4rem" }}>
            <div>
              <div style={{
                fontFamily: "'DM Mono', monospace", fontSize: "0.78rem", fontWeight: 500,
                color: "rgba(200,90,26,0.8)", letterSpacing: "0.08em", textTransform: "uppercase",
                marginBottom: "1rem", display: "flex", alignItems: "center", gap: "0.5rem"
              }}>
                <span style={{ width: "6px", height: "6px", borderRadius: "50%", background: "rgba(200,90,26,0.8)", display: "inline-block" }} />
                the platform
              </div>
              <div style={{ width: "32px", height: "2px", background: "rgba(255,255,255,0.15)" }} />
            </div>
            <div>
              <h2 style={{ fontSize: "2.2rem", fontWeight: 300, letterSpacing: "-0.035em", lineHeight: 1.15, marginBottom: "1.5rem" }}>
                What is{" "}
                <em style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontWeight: 400, color: "rgba(255,255,255,0.35)" }}>
                  Hyphertext?
                </em>
              </h2>
              <p style={{ fontSize: "0.97rem", color: "rgba(255,255,255,0.48)", fontWeight: 300, lineHeight: 1.9, marginBottom: "1.25rem" }}>
              ...
              <p style={{ fontSize: "0.97rem", color: "rgba(255,255,255,0.48)", fontWeight: 300, lineHeight: 1.9, marginBottom: "2.5rem" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1px", background: "rgba(255,255,255,0.07)", borderRadius: "6px", overflow: "hidden" }}>
                {[
                  ...
                  <div key={title as string} style={{ padding: "1.25rem 1.5rem", background: "rgba(255,255,255,0.03)" }}>
                    <div style={{ fontSize: "0.84rem", fontWeight: 500, color: color as string, marginBottom: "0.3rem" }}>{title}</div>
                    <div style={{ fontSize: "0.8rem", color: "rgba(255,255,255,0.3)", fontWeight: 300 }}>{desc}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section style={{ borderBottom: "1px solid var(--border)", background: "#FAF9F5" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto", padding: "5rem 2.5rem" }}>
          <div className="two-col" style={{ display: "grid", gridTemplateColumns: "220px 1fr", gap: "4rem" }}>
            ...
            <div>
              <p style={{ fontSize: "0.97rem", color: "#555", fontWeight: 300, lineHeight: 1.9, marginBottom: "1.5rem" }}>
              ...
              <p style={{ fontSize: "0.97rem", color: "#555", fontWeight: 300, lineHeight: 1.9 }}>
      ...
      <section style={{ borderBottom: "1px solid var(--border)" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto", padding: "5rem 2.5rem" }}>
          <div className="two-col" style={{ display: "grid", gridTemplateColumns: "220px 1fr", gap: "4rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
              <div>
                <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.7rem", fontWeight: 500, color: "#aaa", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "0.5rem" }}>email</div>
                ...
                <p style={{ fontSize: "0.85rem", color: "#999", fontWeight: 300, marginTop: "0.35rem" }}>For support, feedback, partnerships, or anything else.</p>
              </div>
              <div>
                <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.7rem", fontWeight: 500, color: "#aaa", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "0.5rem" }}>location</div>
              ...
              <div>
                <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.7rem", fontWeight: 500, color: "#aaa", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "0.5rem" }}>response time</div>
                <div style={{ fontSize: "0.9rem", color: "#666", fontWeight: 300, lineHeight: 1.7 }}>We aim to reply within 24–48 hours on business days. We read every message.</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ background: "#111", color: "#F4F2ED" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto", padding: "5rem 2.5rem", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "2rem", flexWrap: "wrap" }}>
          <div>
            <div style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.72rem", color: "rgba(255,255,255,0.25)", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "0.75rem", fontWeight: 500 }}>
              ready to build?
            </div>
            <h2 style={{ fontSize: "2.2rem", fontWeight: 300, letterSpacing: "-0.035em", color: "#F4F2ED", marginBottom: "0.5rem", lineHeight: 1.15 }}>
              Your first site is{" "}
              <em style={{ fontFamily: "'Playfair Display', serif", fontStyle: "italic", color: "rgba(255,255,255,0.3)" }}>free.</em>
            </h2>
            <p style={{ fontSize: "0.9rem", color: "rgba(255,255,255,0.35)", fontWeight: 300 }}>Forever. No card required.</p>
          </div>
          <Link href="/auth" style={{
      ...
      <footer style={{ background: "#0a0a0a", borderTop: "1px solid #1f1f1f", padding: "3rem 2.5rem" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1.5rem" }}>
          ...
          <div style={{ display: "flex", gap: "2.25rem", flexWrap: "wrap" }}>
            {[["Explore", "/explore"], ["Privacy", "/privacy"], ["Terms", "/terms"]].map(([label, href]) => (
              <Link key={href} href={href}
                style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.88rem", color: "rgba(255,255,255,0.38)", textDecoration: "none", letterSpacing: "0.01em", fontWeight: 400, transition: "color 0.15s" }}
          ...
          <span style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.8rem", color: "rgba(255,255,255,0.22)", fontWeight: 400, letterSpacing: "0.02em" }}>
