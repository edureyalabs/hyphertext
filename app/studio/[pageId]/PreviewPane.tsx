    ...
    <div style={{
      ...
      {viewMode === 'code' && (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          {hasUnsyncedChanges && (
            <div style={{ background: '#1a1a2e', borderBottom: '1px solid #2d2d4e', padding: '0.4rem 1rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
