...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .placeholder { text-align: center; color: #bbb; max-width: 320px; padding: 2rem; }
    .placeholder-icon { width: 48px; height: 48px; margin: 0 auto 1.25rem; opacity: 0.25; }
    .placeholder h2 { font-size: 0.95rem; font-weight: 400; color: #aaa; margin-bottom: 0.85rem; letter-spacing: -0.01em; }
    .placeholder-hints { display: flex; flex-direction: column; gap: 0.45rem; list-style: none; }
    .placeholder-hints li { font-size: 0.72rem; font-family: 'DM Mono', monospace; color: #ccc; display: flex; align-items: center; justify-content: center; gap: 0.4rem; }
    .placeholder-hints li::before { content: ''; width: 3px; height: 3px; border-radius: 50%; background: #ddd; flex-shrink: 0; }
  </style>
</head>
<body>
